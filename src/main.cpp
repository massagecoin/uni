...
uint256 hashGenesisBlock("0x00000d10ed1ab30c2d0c82630043946fa795008f96a48fdfa4ffe2b6f408014f");
...
{
        static const int64 BlocksTargetSpacing = 60; // UniverseCoin: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // UniverseCoin: 1 day
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000d10ed1ab30c2d0c82630043946fa795008f96a48fdfa4ffe2b6f408014f");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "UNC";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 535 * COIN;
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x26ddde9231fff9006706d11a07871470b19be880c584b0f4225bca698867ed36"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // UniverseCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UniverseCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UniverseCoinMiner : ProcessBlock, block not accepted");
    }
